...
into more detail about this topic in the "Introspection" section, and the [introspection](https://EKKARAT.W@gmail.com/github.com/graphql/graphql-js/blob/master/src/type/introspection.js)
file in GraphQL.js
